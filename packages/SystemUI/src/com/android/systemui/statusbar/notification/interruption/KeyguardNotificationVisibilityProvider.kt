...
private class KeyguardNotificationVisibilityProviderImpl @Inject constructor(
    ...
    private val mHandlerThread: HandlerThread = HandlerThread("KeyguardNotificationVis")
    ...
    override fun start() {
        ...
        userTracker.addCallback(userTrackerCallback, HandlerExecutor(mHandlerThread.getThreadHandler()))
    }
